Consigne pour télécharger le .exe

Vous pouvez télécharger l’application .exe avec ce lien :

https://drive.google.com/file/d/19D168m6MGTt_AvP4NuA995brggKlUT5D/view?usp=sharing
...
pour les fichiers exécutables. Si vous êtes sûr de la source du fichier (dans ce cas, le lien que j’ai fourni),
vous pouvez choisir de poursuivre le téléchargement et l’installation.

//------------------------------------------------------------------------------------------------//

Rules for .exe download
...
If you are sure of the source of the file (in this case, the link I provided), you can choose to continue the download and installation.
